            ...
            <div className="flex flex-col items-center justify-center gap-4">
                ...
                <div className="space-y-3 text-center">
                    ...
                    <p className="text-lg text-gray-400 mx-auto max-w-lg">
                        The last payment of your subscription got failed please check your balance or &nbsp;
                        <Link href={`${process.env.WEB_BASE_URL}/contact-us`} className='text-blue-600 underline'>
                            contact us
                        </Link>
                    </p>
                </div>
